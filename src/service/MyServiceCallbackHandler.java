...
/**
 * MyServiceCallbackHandler Callback class, Users can extend this class and implement their own
...
public abstract class MyServiceCallbackHandler {
   ...
   */
  public void receiveResultgetDoctors(service.MyServiceStub.GetDoctorsResponse result) {}
